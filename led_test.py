...
def run_cameras():
	...
	right_camera.start()
	net=detectNet(model="final3_100/ssd-mobilenet.onnx", labels="final3_100/labels.txt",
	...
	if left_camera.video_capture.isOpened() and right_camera.video_capture.isOpened():
		try:
			...
			while display.IsStreaming():
				...
				resize_l_img = resize(l_img,(960, 720))
				resize_r_img = resize(r_img,(960, 720))
				detection_l = net.Detect(resize_l_img)
				detection_r = net.Detect(resize_r_img)

				cudaDrawLine(resize_l_img,(360,0),(240,720),(255,1,1,255),5)
				cudaDrawLine(resize_l_img,(600,0),(720,720),(255,1,1,255),5)

				cudaDrawLine(resize_r_img,(360,0),(240,720),(255,1,1,255),5)
				cudaDrawLine(resize_r_img,(600,0),(720,720),(255,1,1,255),5)


				if detection_l!=None:
					for i in detection_l:
						if i.ClassID==1:
							if  (6*i.Center[0] + i.Center[1]) >= 2160 and (6*i.Center[0] - i.Center[1])<= 3600 :
								detect_l= detect_l+1
